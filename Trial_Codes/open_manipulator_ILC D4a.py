...
def send_pose_home():
    ...
    try:
        ...
        target_pose = Pose()
        target_pose.position = Point(x=0.12, y=0.0, z=0.19)
        roll, pitch, yaw = 0, 0.5, 0
...
start_x = 0.12  # Starting x-coordinate
...
def trial_loop():
    ...
    for n in range(trials):
        ...
        if n + 1 == 35:  # Check if it's trial number 35
